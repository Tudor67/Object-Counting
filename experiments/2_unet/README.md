...
|`U-Net, full images`           |`LogCosh`|`31/50` |`19.68` |`35.41` |`14.00%` | `1.92%`|`15.92%` |
| U-Net, patches 32 * (128x128) | MSE     | 50/50  | 25.02  | 44.79  | 16.99%  |  3.24% | 20.23%  |
| U-Net, patches 32 * (128x128) | LogCosh | 50/50  | 27.72  | 45.63  | 22.08%  |  0.33% | 22.41%  |
